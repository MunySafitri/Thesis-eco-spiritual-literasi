              ...
              <b-card1 no-body>
                <b-tabs pills card vertical nav-wrapper-class="w-30">
                  ...
                  <b-tab title="TP"
                    ...
                    ></b-tab
                  >
                  <!-- <b-tab title="Alur Tujuan Pembelajaran"
                    ><b-card-text>
                      <ul>
                        <li>
                          Mengidentifikasi langkah-langkah penelitian geografi
                          dari gejala-gejala geosfer dalam kehidupan
                          sehari-hari.
                        </li>
                        <li>
                          Mengidentifikasi keterkaitan antar gejala geosfer dari
            ...
            <b-tab title="Glosarium & Daftar Pustaka"
              ><b-card
                ...
                <ol type="a">
                  ...
                  <li>
                    Transpirasi: Pelepasan uap air oleh tanaman melalui stomata
                    pada daun.
                  </li>
                  <li>
                    Konveksi: Perpindahan panas melalui pergerakan massa udara
                    atau air.
                  </li>
                  <li>
                    Presipitasi: Bentuk pengembalian air ke permukaan bumi
                    melalui hujan, salju, embun, atau bentuk presipitasi
                    lainnya.
                  </li>
                  <li>
                    Infiltrasi: Proses air yang meresap ke dalam tanah setelah
                    presipitasi.
                  </li>
                </ol>
              </b-card>
              <b-card
                ...
                <ol type="a">
                  ...
                  <li>
                    Biodiversitas: Keanekaragaman hayati dalam suatu ekosistem,
                    mencakup keanekaragaman jenis, genetik, dan ekosistem.
                  </li>
                  <li>
                    Konservasi: Upaya untuk melindungi dan mempertahankan sumber
                    daya alam serta ekosistem agar tetap lestari.
                  </li>
                  <li>
                  ...
                  <li>
                    Daur Biogeokimia: Pergerakan unsur-unsur kimia melalui
              ...
              <b-card
                ...
                <ol type="a">
                  <li>
                    Akuifer: Lapisan tanah atau batuan yang dapat menyimpan dan
                    mengalirkan air tanah.
                  </li>

                  <li>
                    Tanggul: Struktur buatan manusia untuk mengendalikan aliran
                    air, seperti tanggul sungai atau bendungan.
                  </li>
                  <li>
                    Air Tanah: Air yang terdapat di dalam pori-pori tanah di
                    bawah permukaan tanah.
                  </li>
                  <li>
                    Air Permukaan: Air yang terdapat di sungai, danau, atau
                    laut.
                  </li>
                </ol>
              </b-card>
              <b-card
                ...
                <ol type="a">
                  ...
                  <li>
                    Limbah Industri: Zat-zat berbahaya yang dibuang oleh
                    kegiatan industri ke dalam air.
                  </li>
                </ol>
              </b-card>
              <b-card
                ...
                <ol type="a">
                  <li>
                    Irigrasi: Pengaturan aliran air untuk meningkatkan produksi
                    tanaman.
                  </li>
                  <li>
                    Pengolahan Air: Proses membersihkan air dari kontaminan
                    untuk membuatnya aman untuk dikonsumsi atau dikembalikan ke
                    lingkungan.
                  </li>
                  <li>
                    Konservasi Air: Praktik untuk mengurangi penggunaan air dan
              ...
              <b-card>
                ...
                <p>
                  Noorhidayati, S., Ahmadi, I., & Sari, N. R. (2022). Developing
                  Hydrotheology Concept in Islamic Perspective. Asian Social
                  Science and Humanities Research Journal (ASHREJ), 4(1), 30-36.
                </p>
                <p>
                  Rehman, K. U. (2022). The Implications Of Water On Islamic
                  Beliefs In The Perspectives Of The Holy Quran. Al-Idah, 40(2),
                  247-260.
                </p>
                <p>
                  Rahmatina, N., Wardani, W., & Saputra, R. (2022). Water Crisis
                  Solutions In The Qur'an And Science. Jurnal Ilmiah Ilmu
                  Ushuluddin, 21(2), 221-240.
                </p>
              </b-card>
            </b-tab>
          </b-tabs>
