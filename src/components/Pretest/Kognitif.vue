...
<template>
  ...
  <div v-if="kognitif[questionIndex]">
    <div class="container p-2">
            ...
            <div class="radio-list" style="font-size:2vw;">
              ...
              <div v-for="(k, index) in kognitif" :key="k.id" class="question-content">
                <div v-show="index === questionIndex" class="question question-box">
                  ...
                  <ul>
                    <li class="radio-item " v-for="(response) in k.opsi" :key="response.id">

                      <input @click="emitSelectedOption(index + 1, response.id)" :id="response.id + k.pertanyaan"
                        type="radio" v-bind:value="response.isi" v-bind:name="response.isi"
                        v-model="userResponses[index]">
                      <label :for="response.id + k.pertanyaan">{{ response.id }}. {{ response.isi }}
                      </label>
                  ...
                  <!-- <div class="col d-flex justify-content-between">
                    ...
                    <div class="row" v-if="questionIndex === kognitif.length - 1">
                    ...
                    <div v-else class="ml-auto p-2">
                      <button  class="ml-auto btn btn-lg btn-secondary " :class="choose ? '' : 'disabled'" v-if="questionIndex === kognitif.length - 1"
                        v-on:click="next">
                        Next
                      </button>
                    </div>
      ...
      <div v-if="questionIndex === kognitif.length - 1" class="d-flex justify-content-sm-end pt-5">
        <!-- <button type="button" class="next round" >&#8250;</button> -->
        <!-- <h1>klik ke PPL</h1> -->
        <CButton class=" btn-lg" :class="choose ? '' : 'disabled'" color="success" @click="() => {
      ...
      <div v-else class="d-flex justify-content-sm-end pt-5">
        <button class="btn btn-lg btn-secondary" :class="choose ? '': 'disabled'" @click="nextQuestion">Berikutnya &#8250;</button>
      </div>
    </div>
  </div>
  ...
  <!-- <div v-else>
    ...
    <button class="btn btn-success" @click="addData"> Data hasil jawabn disimpan</button>
  </div> -->
...
var kognitif = [
  {
    "id": "1",
    "gambar": "Gambar_Soal_No_1.png",
    "pertanyaan": "Berdasarkan gambar diatas, Urutan proses siklus hidrologi yang benar adalah ….",
    "opsi": [
      {
        "id": "a",
        "isi": "1, 2, 3, dan 4"
  ...
  },
  {
    "id": "2",
    "gambar": null,
    "pertanyaan": "Berikut ini yang merupakan pasangan yang tepat mengenai jenis proses yang terjadi dalam daur air dengan keterangannya yang tepat adalah…",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "6",
    "gambar": null,
    "pertanyaan": "Daur air adalah perubahan yang terjadi pada air secara berulang dalam suatu pola tertentu. Air di sungai, danau, rawa, laut, serta hasil transpirasi tumbuhan akan menguap membentuk awan. Awan tersebut adalah hasil…",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "8",
    "gambar": null,
    "pertanyaan": "Salah satu fungsi hutan adalah untuk menjaga cadangan dan kualitas air di daerah sekitarnya. Jika terjadi deforestasi di suatu kawasan hutan tersebut, maka fenomena apa yang akan terjadi berkaitan dengan fungsi hutan tersebut…",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "9",
    "gambar": null,
    "pertanyaan": "Taman Nasional Bali adalah wilayah hutan yang menjadi satu-satunya Taman Nasional yang terdapat di Bali, selain sebagai tempat penangkaran alami satwa endemic, yaitu Jalak Bali. Peranan vegetasi hutan dalam siklus hidrologi adalah...",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "10",
    "gambar": null,
    "pertanyaan": "Kegiatan reboisasi dengan menanami pohon pada hutan gundul mempengaruhi proses siklus hidrologi dan berdampak positif bagi pencegahan banjir. Fungsi pepohonan hutan dalam siklus hidrologi adalah...",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "11",
    "gambar": null,
    "pertanyaan": "Pemerintah Kabupaten Gorontalo Utara akan melakukan program reboisasi berkelanjutan guna menutupi sejumlah lahan dan hutan yang kritis akibat musim kemarau panjang.(Antaranews, 2018). Program tersebut berpengaruh terhadap tahapan siklus air karena ….",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "12",
    "gambar": null,
    "pertanyaan": "Kurangnya air di bumi dapat menyebabkan banyaknya hewan yang mengalami dehidrasi dan tumbuhan yang tidak tumbuhan dengan baik. Kesimpulan yang didapat dari peristiwa diatas adalah ….",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "14",
    "gambar": null,
    "pertanyaan": "Manusia membutuhkan air tanah yang bersih untuk dikonsumsi. Dikutip dari detikhelt sumber mata air terbaik berasal dari pegunungan. Jika dikaitkan dengan proses hidrologi, yang menjadi penyebab sumber mata air pegunungan menjadi yang terbaik adalah …...",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "15",
    "gambar": null,
    "pertanyaan": "Menurut ayah, Saat hujan keberadaan hutan sangat penting karena hutan menyebabkan air tanah semakin banyak sehingga air yang ada dalam hutan lebih bersih. Pendapat ayah benar karena …..",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "16",
    "gambar": null,
    "pertanyaan": "Masyarakat disuatu desa percaya,air yang berada di hutan sangat lebih bersih. Hal ini disebabkan karena ….",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "17",
    "gambar": null,
    "pertanyaan": "Berikut ini yang merupakan faktor alami penyebab masalah lingkungan hidup adalah….",
    "opsi": [
      {
        "id": "a",
        "isi": "Banjir"
  ...
  },
  {
    "id": "18",
    "gambar": null,
    "pertanyaan": "Banyak air sungai yang tercemar minyak. Saat proses siklus air pengaruh kualitas air terhadap proses siklus air tersebut adalah ….",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "19",
    "gambar": null,
    "pertanyaan": "Berdasarkan sebuah penelitian pada tahun 2017, kandungan pH air hujan yang menigisi di danau buyan adalah 4 dan mengandung zat kimia yang berlebihan. Namun apabila hanya dilihat sebentar air di danau Buyan tetap jernih dan tidak berbau. Berdasarkan hal tersebut, apa yang dapat disimpulkan …. ",
    "opsi": [
      {
        "id": "a",
  ...
  },
  {
    "id": "20",
    "gambar": null,
    "pertanyaan": "Untuk menghidari efek bencana tanah longsor pemerintah terhadap kandungan air permukaan,  menggalakkan penanaman 1001 pohon. Tujuan dilakukannya hal tersebut adalah ….",
    "opsi": [
      {
        "id": "a",
