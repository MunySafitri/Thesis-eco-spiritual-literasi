            ...
            <div class="card-body p-3" style="font-size: 1.2em">
              ...
              <b-form class="p-3" @submit="onSubmit" @reset="onReset" v-if="show">
                ...
                <b-row class="my-2">
                  ...
                  <b-col sm="9">
                    <b-form-input trim id="type-email" v-model="form.email" type="email" aria-describedby="input-live-help input-live-feedback"  :state="errors.includes('email_required') || errors.includes('email_wrong') ? false : none"
                      ...
                      <b-form-invalid-feedback v-if="errors.includes('email_wrong')" id="type-password">
                ...
                <b-row class="my-2">
                  ...
                  <b-col sm="9">
                    <b-form-input  id="type-password" v-model="form.password" type="password" aria-describedby="input-live-help input-live-feedback"  :state="errors.includes('password_required') || errors.includes('password_wrong') ? false : none"
                      placeholder="Masukkan Password.."></b-form-input>
                      <b-form-invalid-feedback v-if="errors.includes('password_required')" id="type-password">
                      Password Perlu ditambahkan
                      </b-form-invalid-feedback>
                      <b-form-invalid-feedback v-if="errors.includes('password_wrong')" id="type-password">
